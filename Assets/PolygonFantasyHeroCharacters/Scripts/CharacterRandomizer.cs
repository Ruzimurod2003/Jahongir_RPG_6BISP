...
namespace PsychoticLab
{
    ...
    public class CharacterRandomizer : MonoBehaviour
    {
        ...
        void RandomizeColors(SkinColor skinColor)
        {
            ...
            if (primary.Length != 0)
                mat.SetColor("_Color_Primary", primary[UnityEngine.Random.Range(0, primary.Length)]);
            else
                Debug.Log("No Primary Colors Specified In The Inspector");

            // randomize and set secondary color
            if (secondary.Length != 0)
                mat.SetColor("_Color_Secondary", secondary[UnityEngine.Random.Range(0, secondary.Length)]);
            else
                Debug.Log("No Secondary Colors Specified In The Inspector");

            // randomize and set primary metal color
            if (metalPrimary.Length != 0)
                mat.SetColor("_Color_Metal_Primary", metalPrimary[UnityEngine.Random.Range(0, metalPrimary.Length)]);
            else
            ...
            if (metalSecondary.Length != 0)
                mat.SetColor("_Color_Metal_Secondary", metalSecondary[UnityEngine.Random.Range(0, metalSecondary.Length)]);
            else
            ...
            if (leatherPrimary.Length != 0)
                mat.SetColor("_Color_Leather_Primary", leatherPrimary[UnityEngine.Random.Range(0, leatherPrimary.Length)]);
            else
            ...
            if (leatherSecondary.Length != 0)
                mat.SetColor("_Color_Leather_Secondary", leatherSecondary[UnityEngine.Random.Range(0, leatherSecondary.Length)]);
            else
                Debug.Log("No Secondary Leather Colors Specified In The Inspector");

            // randomize and set body art color
            if (bodyArt.Length != 0)
                mat.SetColor("_Color_BodyArt", bodyArt[UnityEngine.Random.Range(0, bodyArt.Length)]);
            else
                Debug.Log("No Body Art Colors Specified In The Inspector");

            // randomize and set body art amount
            mat.SetFloat("_BodyArt_Amount", UnityEngine.Random.Range(0.0f, 1.0f));
        }
        ...
        void RandomizeAndSetHairSkinColors(string info, Color[] skin, Color[] hair, Color stubble, Color scar)
        {
            ...
            if (skin.Length != 0)
            {
                mat.SetColor("_Color_Skin", skin[UnityEngine.Random.Range(0, skin.Length)]);
            }
            else
            {
            ...
            if (hair.Length != 0)
            {
                mat.SetColor("_Color_Hair", hair[UnityEngine.Random.Range(0, hair.Length)]);
            }
            else
            {
