...
public class CFX_Demo : MonoBehaviour
{
    ...
    LOOP:
        ...
        else particles.transform.position = this.transform.position + new Vector3(UnityEngine.Random.Range(-range, range), 0, UnityEngine.Random.Range(-range, range)) + new Vector3(0, particles.transform.position.y, 0);
